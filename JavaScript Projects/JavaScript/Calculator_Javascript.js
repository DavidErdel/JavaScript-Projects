...
const Calculator = {
    ...
    First_Operand: null,
    //This checks whether or not the seocnd operand has been inputted by the user.
...
function Input_Decimal(dot) {
    //This ensures that accidental clickin of the decimal point doesn't
...
function Handle_Operator(Next_Operator) {
    ...
    //Calculaor.First_Operand if it doesn't already exist.
    const Value_of_Input = parseFloat(Display_Value);
    //Checks if an operator already exists and if Wait_Second _Opoerator is true,
...
//This function updatest he calculator screen with the contents of Display_Value
