...
function placeXOrO(squareNumber) {
    //This condition ensures a sqaure hasn't already been selected.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            //This fucntion waits one second before the computer places an image and enables click.
...
//drawLine() function is called to draw a line on the screnn if the condition is met.
function checkWinConditions() {
    ...
    //O 6, 7, 8 condition.
    else if (arrayIncludes('0O', '3O', '8O')) {drawWinLine(50, 508, 558, 508) }
    //O 0, 3, 6 condition.
    ...
    //9 squares are selected, then the code executes.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        //These three variableswill be use to check for 3 in a row.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //This line indicates where the end of a line's x asix is.
        x2 = coordX2,
        ...
        function animateLineDrawing() {
            ...
            if (x1 <= x2 && y1 <= y2) {
                ...
                if (x < x2) { x += 10; }
                //This dondition adds 10 to the previous end y endpoint.
                if (y < y2) { y += 10; }
